...
- (UIView *)createContainerView
{
    ...
    if (NO == self.isHideDefaultBackground) {
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        UILabel *lineOfButton = [[UILabel alloc]initWithFrame:CGRectMake(i * buttonWidth, container.bounds.size.height - buttonHeight, 0.5 , buttonHeight)];
        lineOfButton.backgroundColor = [UIColor grayColor];
        [container addSubview:lineOfButton];
